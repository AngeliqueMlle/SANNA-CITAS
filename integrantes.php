...
<body>
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container py-5">
            <h1 class="display-3 text-white mb-3 animated slideInDown">Integrantes</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb text-uppercase mb-0">
                    <li class="breadcrumb-item"><a class="text-white" href="#">Inicio</a></li>
                    <li class="breadcrumb-item"><a class="text-white" href="#">Más</a></li>
                    <li class="breadcrumb-item text-primary active" aria-current="page">Integrantes</li>
                </ol>
            </nav>
        </div>
    </div>
            ...
            <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.1s">
                ...
                <div class="testimonial-item text-center">
                    ...
                    <div class="testimonial-text rounded text-center p-4">
                        ...
                        <h5 class="mb-1">Ruth Angelica Enciso Contreras</h5>
                        <span class="fst-italic">Ingeniería de Sistemas Computacionales</span>
                    </div>                   
                </div>
            </div>
